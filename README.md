# Yodata Activity Streams OpenAPI Specification
[![Build Status](https://travis-ci.org/Yodata/activity-streams-api.svg?branch=master)](https://travis-ci.org/Yodata/activity-streams-api)
...
6. If you did everything correct, https://yodata.github.io/activity-streams-api/ will lead to your new docs
...
- Documentation(ReDoc): https://yodata.github.io/activity-streams-api/
- SwaggerUI: https://yodata.github.io/activity-streams-api/swagger-ui/
- Look full spec:
    + JSON https://yodata.github.io/activity-streams-api/swagger.json
    + YAML https://yodata.github.io/activity-streams-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://yodata.github.io/activity-streams-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://yodata.github.io/activity-streams-api/ with url from the message: `Server started <url>`
